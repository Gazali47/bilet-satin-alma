...
<div class="card">
    ...
    <a href="/firma-admin/sefer-ekle.php" class="btn btn-success" style="margin-bottom: 20px;">
        ➕ Yeni Sefer Ekle
    </a>
</div>
...
<div class="card">
            ...
            <tbody>
                <?php foreach ($trips as $trip): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/firma-admin/sefer-duzenle.php?id=<?php echo $trip['id']; ?>" 
                               class="btn btn-primary" style="padding: 8px 15px; font-size: 12px;">
                                ✏️ Düzenle
                            </a>
                            <a href="/firma-admin/index.php?delete=<?php echo $trip['id']; ?>" 
    ...
    <?php else: ?>
        <div class="alert alert-info">
            Henüz sefer eklenmemiş. <a href="/firma-admin/sefer-ekle.php">Yeni sefer ekleyin</a>.
        </div>
    <?php endif; ?>
</div>
